    ...
    >
        <div className="flex flex-col gap-2 text-left mb-5">
          ...
          <p className="text-balance font-medium text-sm text-muted-foreground">
            {isSignUp? "Sign up with your school email to get started." : "Sign in with your school email to access your account."}
          </p>
        ...
        <div className="grid gap-3">
          {isSignUp && (
            ...
            <input
              ...
              onChange={(e) => handleAuthenFormChange("firstName", e.target.value)}
              required
          ...
          <div className="grid gap-1">
            ...
            <input
              ...
              onChange={(e) => handleAuthenFormChange("lastName", e.target.value)}
              required
              className='input-field'
            />
          </div>
        ...
        <div className="grid gap-1">
          ...
          <input
            ...
            onChange={(e) => handleAuthenFormChange("institution", e.target.value)}
            required
            className='input-field'
          />
        </div>
        ...
        <div className="grid gap-1">
          <label className='font-medium'> {isSignUp? "New password": "Password"} </label>
          <input
            id="password"
            type="password"
        ...
        <div className="grid gap-1">
          ...
          <input
            ...
            onChange={(e) => handleAuthenFormChange("confirmPassword", e.target.value)}
            required
            className='input-field'
          />
        </div>
        ...
        <div className="text-center text-sm">
          ...
          <a href={isSignUp? "/sign-in" : "/sign-up"} className="ml-2 underline underline-offset-4 hover:text-primaryOrange">
